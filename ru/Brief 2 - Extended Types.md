...
Перечисления `enum` – это специальный тип, который обеспечивает решение проблемы специальных чисел.
...
Данный тип можно эффективно использовать, когда тип данных заранее неизвестен и определяется динамически, во время исполнения. Например, функция которая принимает и обрабатывает строку в JSON формате, на выходе будет иметь объекты разного типа
